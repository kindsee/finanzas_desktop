...
# -*- coding: utf-8 -*-
"""
Script para ejecutar migración: Añadir campo visible a account
"""
...
def main():
    print("=" * 60)
    print("  MIGRACIÓN: Añadir campo visible a account")
    print("=" * 60)
    
    script_dir = os.path.dirname(os.path.abspath(__file__))
    sql_file = os.path.join(script_dir, "add_visible_field_to_account.sql")
    ...
    print("\n⚠️  Esta migración añadirá la columna 'visible' a:")
    print("   - Tabla: account")
    print("   - Valor por defecto: 1 (visible)")
    print("\n   Este campo controla si la cuenta aparece en la UI")
    ...
    if success:
        ...
        print("=" * 60)
        print("\n💡 Ahora las cuentas recordarán su estado de visibilidad")
    else:
        print("\n" + "=" * 60)
